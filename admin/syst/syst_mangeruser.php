  ...
  <div class="allRoundedCorner">
     ...
     <div id="allbox">
	  ...
	  <?php for($i=0;$i<count($row);$i++){?>
			...
			<td width='155px'><a class='edit' href='syst_edituser.php?id=<?php echo $row[$i][5]; ?>&username=<?php echo $row[$i][0]?>&psw=<?php echo $row[$i][1]?>&dept=<?php echo $row[$i][3]?>&code=<?php echo $row[$i][6]?>'>修改</a></td>
