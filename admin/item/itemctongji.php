...
if($_POST["submit"] == "导出Excel"){
	$file_name = iconv("UTF-8","GB2312",'学院项目统计表');	
    ...
    <tr>
      <th colspan=6 align="center"><?php echo $tongji->getYear()?>年各学院素拓项目统计表<small>(导出时间:<?php echo getNowDate()?>)</small></th>
    </tr>
   ...
   <tr>
   	<td>&nbsp;东方院</td>
			<?php $DFitem = $tongji->countDFItem();
				$DFcredit = $tongji->countDFValidCreditANDLessonCreditByOrg();
			?>
	...
	foreach ($org_data as $v){
		$item = $tongji->countItemByOrgId($v['org_no']);
		$credit=$tongji->countValidCreditANDLessonCreditByOrg($v['org_no'])
			?>
			<tr>
...
<body>
 <div class="allRoundedCorner">
     ...
     <div id="allbox">
      ...
      <div class="alltitle">各学院素拓项目统计</div>
