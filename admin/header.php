...
<div id="scrlContainer">系统公告：
   ...
   <!--   //隐藏系统消息
      ...
      -->
	  <a href="http://10.8.9.9/doc/admin.rar">[管理员使用手册]湖南农业大学课程管理平台 <b>提供下载</b></a> ，教师使用手册已在前端通知发布！&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <a href="http://10.8.9.9/doc/ppt_v3.1.rar">本科评估多媒体汇报材料模板第三版最终修改版 <b>提供下载</b></a>
   </div>
</div>
