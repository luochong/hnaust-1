   ...
   <div id="leftmenu">
	...
	<div class="hand" onclick="hide('hideMenuFunc6')">项目管理</div>
	  <div id="hideMenuFunc6">
	      <div><a href="stud/stud_dangmgf.php" target="main">项目管理</a></div>
		  <div><a href="stud/stud_reward.php" target="main">项目管理</a></div>
		  <div><a href="stud/stud_punish.php" target="main">项目管理</a></div>
